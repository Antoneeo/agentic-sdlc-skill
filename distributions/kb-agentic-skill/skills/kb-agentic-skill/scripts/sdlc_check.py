...
From the overlay:
  ...
  stale    [--root R] [--hybrid]            spine staleness PLUS `## claims`:
                                            superseded-cited docs, expired
                                            windows, superseded chains (F-044)
  index / validate / check                  spine behaviour PLUS the kb surface
                                            (byte-identical output on a tree
                                            with no topics/ or corpus/)

Every other spine subcommand (mark, gate, orient, plan, migrate, and any

...
- **2026-09-01 (release) — shipped and published.** Unit commit `c2d03ef`, release commit `2a70dab` (tags `v1.30.0`, `kb-v1.12.0`, `mkt-v0.8.0`, all == HEAD, pushed). GUIDE_release battery all green pre-tag (pack ×3 clean, init smoke CLEAN, check --hybrid CLEAN, unittest 184+369+202 OK). Owner published; registry verified: code 1.30.0, kb 1.12.0, mkt 0.8.0.

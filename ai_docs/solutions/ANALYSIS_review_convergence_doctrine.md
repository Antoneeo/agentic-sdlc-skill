...
- **2026-09-01 (release) — shipped and published.** Unit commit `fcccf21`, release commit `8b2e8a9` (tags `v1.30.0`, `kb-v1.12.0`, `mkt-v0.8.0`, all == HEAD, pushed). GUIDE_release battery all green pre-tag (pack ×3 clean, init smoke CLEAN, check --hybrid CLEAN, unittest 184+369+202 OK). Owner published; registry verified: code 1.30.0, kb 1.12.0, mkt 0.8.0.

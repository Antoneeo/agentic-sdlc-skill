...
- 2026-08-28: unit opened on `feat/kb-capture-moment` off main@8260f84. Design decision made before drafting: no SessionEnd/Stop hook — SessionEnd cannot reach the model and a Stop hook is per-turn noise; the honest by-construction limb is recency visibility in the F-039 orient append.

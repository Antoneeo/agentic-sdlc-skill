...
- **Scala di enforcement (decisa 2026-07-02)**: (1) **meccanico** — validatore/hook/vincolo strutturale, sempre preferito quando possibile; (2) **MUST-mode** — imperativo secco stile superpowers, legittimo quando il controllo meccanico non è possibile E la regola è portante (vietarselo = handicap autoimposto), sempre accompagnato dal *perché*; (3) prosa esplicativa per il resto. Sostituisce la vecchia "cautela di stile" della roadmap v1, che vietava il MUST-mode come default.

...
| F-045 Review convergence doctrine (Execute-Before-Specify + review-loop hardening, spine ported) | L3 | main (uncommitted - integration decision pending) | IMPLEMENTED, UNRELEASED | 2026-09-01 | owner decides integration (commit/branch), then release per GUIDE_release (bump x3 + CHANGELOG); Write Triggers row for harness_[feature]/ still open (scoped out on 2026-09-01) | HANDOFF_review_convergence_doctrine.md · ANALYSIS_review_convergence_doctrine.md (full unit record + Diary) |

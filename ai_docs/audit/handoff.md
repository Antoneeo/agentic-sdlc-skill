...
| F-022 Multi-Domain Core | L3 | feat/multi-domain-core | PLANNED | 2026-07-31 | design closed at round cap (3 rounds, 76 findings, all dispositioned in the ANALYSIS v4). Open before P1: (a) copy the kb bundle off this machine (P0), (b) Vision v7 confirming blind round + owner promotion. Then P1 | ANALYSIS_multi_domain_core.md (Diary; no volatile state) |

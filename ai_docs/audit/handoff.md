...
| F-041 KB Mid-Session Drift (field report, 2 items) | L3 | (not yet cut) | OPEN, NOT STARTED | 2026-08-28 | cut a branch, write the ANALYSIS from the evidence below, design review | HANDOFF_kb_midsession_drift.md · this file (evidence verbatim); ANALYSIS to be written |

...
| F-022 Multi-Domain Core | L3 | feat/multi-domain-core | IN_PROGRESS | 2026-07-31 | P0 and P1 done (contract shipped: `routing.md`, review clause, templates, `init.js` sibling path + TS11, ADR, indexes; batteries 75/75 + 11/11 node). Next is P2 — and it opens with TS1's golden fixture + baseline captured from the PRE-change validator, before the first edit to `sdlc_check.py` | ANALYSIS_multi_domain_core.md (Diary; no volatile state) |

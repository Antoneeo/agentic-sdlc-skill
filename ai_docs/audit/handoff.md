...
| F-042 Global orient hook at install time (UX fix of the F-041 note) | L3 | feat/global-orient-hook | DONE, AWAITING MERGE | 2026-08-28 | the owner's merge call (closure PASS in 1 round, 0 BLOCK, 3 WARN folded; JS 50x3, python 184/316/202, gate CLEAN) | HANDOFF_global_orient_hook.md · ANALYSIS_global_orient_hook.md; the owner's design ruling is below |

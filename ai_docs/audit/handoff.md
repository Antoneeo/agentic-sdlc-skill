...
| F-054 kb recall multi-slug verdict (the false-negative claim was refuted; the verdict form was the real gap) | L2 | main | DONE, UNRELEASED | 2026-09-12 | owner's integration call; kb-only delta, so a single-package release when they call it | HANDOFF_kb_recall_verdict.md · SPIKE_kb_recall_second_instrument.md (the negative spike this unit came out of); harness_kb_recall_probe/{probe.py,replay_2026-09-12.md} |

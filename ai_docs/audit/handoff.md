...
| F-045 Review convergence doctrine (Execute-Before-Specify + review-loop hardening, spine ported) | L3 | main | RELEASED PENDING PUBLISH | 2026-09-01 | owner runs publish_all.bat from repo root (2FA per package) for code 1.30.0 + kb 1.12.0 + mkt 0.8.0, then npm view verifies; Write Triggers row for harness_[feature]/ still open (scoped out on 2026-09-01, recorded in the ADR's Con) | HANDOFF_review_convergence_doctrine.md · ANALYSIS_review_convergence_doctrine.md (full unit record + Diary) |

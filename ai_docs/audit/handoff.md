...
| F-032 Interaction Contract | L3 | feat/interaction-contract | DONE, AWAITING MERGE | 2026-08-04 | the owner's merge call on feat/interaction-contract → main; then release bumps per GUIDE_release.md and the devPNT-repo companion workstream (governed D-IC) | HANDOFF_interaction_contract.md · ANALYSIS_interaction_contract.md · ADR_2026-08-04_interaction_contract_layer.md |

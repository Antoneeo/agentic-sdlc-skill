...
| F-043 Revision doctrine (delta-append is the failure; full re-read is the gesture) | L3 | feat/revision-doctrine | DONE, MERGED | 2026-08-28 | publish kb 1.10.0 (owner's act, publish_all.bat) -> polling verify | HANDOFF_revision_doctrine.md · ANALYSIS_revision_doctrine.md (+ this file: post-mortem verbatim) |

...
| F-053 cross-unit remediation (defects a cross-lens review on a DIFFERENT model found after six units shipped) | L3 | main | PLANNED | 2026-09-11 | open the ANALYSIS and work the four items below, in the stated order (1 and 3 are correctness, not optimization) | HANDOFF_cross_unit_remediation.md · this file is the spec until ANALYSIS_cross_unit_remediation.md exists; findings verified in-repo, numbers reproduced |

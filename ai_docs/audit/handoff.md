...
| F-022 Multi-Domain Core | L3 | feat/multi-domain-core | PLANNED | 2026-07-31 | design closed at the round cap (3 design rounds + 4 blind Vision rounds, all dispositioned). Nothing blocking: P0 closed, Vision v7 APPROVED. Next is P1 execution — `routing.md`, the `review.md` clause, templates, `init.js`, `package.json` files[], Component Map rows, ADR | ANALYSIS_multi_domain_core.md (Diary; no volatile state) |

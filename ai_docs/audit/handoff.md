...
| F-026 revised — a real doubt is asked when it emerges (three lenses) | L3 | feat/ask-when-doubt-emerges | DONE, AWAITING MERGE | 2026-09-25 | after the 1.35.0 release branch is merged into main, open a PR from feat/ask-when-doubt-emerges (it is based on codex/f057-shared-project-memory); then release it as a minor bump in all three packages | HANDOFF_question_discipline.md · ANALYSIS_question_discipline.md · harness_question_discipline/probe.py |

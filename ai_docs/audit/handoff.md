...
| F-036 Init Wires the Orientation Hook | L3 | feat/init-wires-orient-hook | DONE, AWAITING MERGE | 2026-08-25 | the owner's merge call (closure review PASSED after one rework round) | HANDOFF_init_wires_orient_hook.md · ANALYSIS_init_wires_orient_hook.md |
